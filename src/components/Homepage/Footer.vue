<template>
  <div class="px-3 lg:px-6 bg-[#f8f8f8]">
    <div class="mx-auto footer-links pr-6 max-w-6xl">
      <div
        class="py-12 lg:py-24 flex flex-col justify-between lg:flex-row lg:px-0"
      >
        <div class="w-full lg:w-auto">
          ...
          <p class="text-[#7e7e7e] text-sm my-6">
            © 2025 lezada. All Rights Reserved |
            <span class="text-black font-bold"> (+00) 123 567990</span> |
            contact@lezada.com
          </p>
        </div>
            ...
            <ul class="flex space-x-6">
              <li>
                <a
                  ...
                  target="_blank"
                  class="text-[#7e7e7e] hover:text-black transition-colors"
                >
              ...
              <li>
                <a
                  ...
                  class="text-[#7e7e7e] hover:text-black transition-colors"
                >
                  <svg class="w-5 h-5" viewBox="0 0 320 512">
                    <path
              ...
              <li>
                <a
                  ...
                  class="text-[#7e7e7e] hover:text-black transition-colors"
                >
                  <svg class="w-5 h-5" viewBox="0 0 448 512">
                    <path
              ...
              <li>
                <a
                  ...
                  class="text-[#7e7e7e] hover:text-black transition-colors"
                >
                  <svg class="w-5 h-5" viewBox="0 0 576 512">
                    <path
