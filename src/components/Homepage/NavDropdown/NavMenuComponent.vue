<template>
  <div class="w-full duration-500">
    <div
      class="flex justify-between max-w-6xl mx-auto space-x-16 bg-white p-8 pb-2 shadow-sm"
    >
          ...
          <ul class="space-y-2 pb-1">
            ...
            >
              ...
              >
                ...
                <span
                  v-if="link.img"
                  class="absolute z-[100] left-60 opacity-0 scale-75 transition-all duration-300 hover:opacity-100 group-hover:scale-150 w-100"
                >
