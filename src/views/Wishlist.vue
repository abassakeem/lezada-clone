    ...
    >
      ...
      <main class="py-16">
        <div class="container mx-auto px-4">
          <div class="lg:flex justify-center gap-8 w-6xl mx-auto">
            <div class="w-full">
              <div class="mb-8 border border-[#e6e6e6]">
                <table class="w-full">
                  <thead>
                    <tr class="border-b border-[#e6e6e6]">
                      <th class="text-left p-4 px-8 text-lg font-semibold">
                        PRODUCT
                      </th>
                      <th class="text-left p-4 px-8 text-lg font-semibold">
                        PRICE
                      ...
                      <th class="text-right p-4 px-8 text-lg font-semibold">
                        TOTAL
                      </th>
                      <th class="w-20"></th>
                    </tr>
